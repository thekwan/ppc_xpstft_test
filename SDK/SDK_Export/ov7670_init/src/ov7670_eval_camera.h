...
#ifdef DCMI_DEBUG
extern uint32_t dcmi_line_cnt;
extern uint32_t dcmi_vsync_cnt;
extern uint32_t dcmi_frame_cnt;
extern uint32_t dcmi_reg_ndr;
extern uint32_t dcmi_error_code;
#endif
...
void  BSP_OV7670_DISPLAY_FRAME  ( void );
