...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/deokhwan/Work/FPGA/ppc_sccb_ip
  logical library name                       : sccb_ip_test_v1_00_a
  top name                                   : sccb_ip_test
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/sccb_ip_test_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/sccb_ip_test_v2_1_0.tcl
